<%@ Page Language="C#" MasterPageFile="~/student.master" AutoEventWireup="true" CodeFile="stpassword.aspx.cs" Inherits="stpassword" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellpadding="0" cellspacing="0" class="st123" 
        style="width: 655px; height: 219px;">
        <tr>
            <td class="style11">
            </td>
            <td class="style11">
